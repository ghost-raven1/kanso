...
export const seo = defineSeo({
  ...
  lang: 'ru', defaultTitle: 'Kanso framework lab', titleTemplate: '%s · Kanso',
  description: 'React-shaped TSX, Solid reactivity, server rendering and built-in SEO.',
  image: { url: '/og.png', width: 1280, height: 1440, alt: 'Kanso framework laboratory' },
