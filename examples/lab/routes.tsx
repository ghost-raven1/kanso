...
function Layout({ children }: PropsWithChildren) {
  return <>
    <header className="topbar"><Link href="/" class="brand">簡素 <span>kanso</span></Link><span className="version">FRAMEWORK LAB / 0.2</span><a href="https://github.com/solidjs/solid" target="_blank" rel="noreferrer">Powered by Solid ↗</a></header>
