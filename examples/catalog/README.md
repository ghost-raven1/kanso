...
Пример Kanso 0.6: GET-фильтры → карточка товара → серверная валидация → POST/Redirect/GET. SEO и JSON-LD находятся в исходном HTML; форма работает без JavaScript и сохраняет ввод при ошибках.
