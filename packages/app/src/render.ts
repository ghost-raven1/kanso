...
export async function renderPage(options: Pick<RequestHandlerOptions, 'routes' | 'assets' | 'seo' | 'timeoutMs' | 'buildId'>, bootstrap: Bootstrap, status = 200): Promise<Response> {
